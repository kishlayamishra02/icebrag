# Icebrag Kickoff Meeting - Full Script for Kishlaya

This is everything you need to say in the kickoff meeting. Just follow it, and you're good to go.
...
I know some of you might be wondering why we're doing this. Honestly, we have a team of talented developers, and instead of just talking about building something, let's actually build it together. This will look amazing on everyone's portfolio, and we'll learn a ton in the process."

---

## What We're Building (3 minutes)
...
## Team Roles and Responsibilities (4 minutes)
...
**anshuman-work - Frontend Developer 2:**
...
**srishtimehta-13 - Full-Stack Support:**
...
## The 10-Day Timeline (3 minutes)

"Alright, here's how the next 10 days are going to go:

**Day 1 - Today - Setup and Planning:**
This is foundation day. Iaman, you're creating Supabase and seeding test data. Abinash, you're creating the React app and basic layout. anshuman, you're building the components we need. Kamran, you're setting up the Gemini API. Shiven, you're writing the test plan and docs. By the end of today, everyone should be able to run the app locally. We're aiming for 15% done.
...
## How We're Working Together (3 minutes)

"So we've got 10 days. That's actually tight. Here's how we make sure we don't mess it up:

**Communication:**
We're using Discord for quick messages. If you have a question, ask there. Don't wait. If I'm bottlenecking something, let me know.
...
**Standups:**
Every morning, 9 AM IST, we do a 15-minute standup. You say: what did you do yesterday, what are you doing today, are you blocked. That's it. No long meetings. Just sync up.
...
## What Success Looks Like (2 minutes)
...
## Common Issues We're Heading Off (2 minutes)
...
## Deliverables and Documentation (2 minutes)
...
## Final Checklist (1 minute)

"Okay, before we jump in, let me make sure everyone has what they need:

Everyone:
- Do you have the GitHub repo link? (Pause)
- Do you know your role? (Pause)
- Do you have the Discord link? (Pause)

Iaman:
- Do you have the Supabase URL and API keys ready to share? (Pause)

Kamran:
- Do you have your Gemini API key? (Pause)

Shiven:
- Do you have the test plan template? (Pause)

Abinash and anshuman:
- Are you ready to get Iaman's credentials and start building the React app? (Pause)

Great. Then we're good to go."

---

## The Actual Ask (2 minutes)
...
If there are no more questions, then we're good. I'm going to share a detailed day-by-day breakdown in the Discord channel and via email. Read it. It tells you exactly what to do each day, step by step.
...
Send the team:
1. The 10-day plan document
2. The GitHub repo link
3. A Discord channel for quick communication
4. Iaman's Supabase URL and API keys
5. Kamran's API endpoint info
6. A reminder: First standup tomorrow at 9 AM IST

---

## Notes for Delivering This

- Speak clearly and slow enough that people can follow
- Make eye contact (even on video call, look at the camera)
- Pause after important points to let it sink in
- If someone looks confused, ask if they have questions
- Don't rush through the tech stack explanation - that's where people might get lost
- When you're explaining roles, look at the person while explaining their role
- Be enthusiastic. Your energy sets the tone for the whole team
- If someone asks a question you don't know the answer to, say "great question, let me figure that out and get back to you"
- Don't over-explain. You want to be clear, but you also want to keep it moving

---

## Timing

This script should take about 25-30 minutes total. That leaves you with 5-10 minutes for questions and wrap up. Perfect for a 30-45 minute meeting.

If you need to cut time, the sections you can shorten are:
- Tech stack (you can do this in 2 minutes instead of 3)
- Common issues (can do in 1 minute)
- Deliverables (can skip if everyone's clear)

But don't cut the team roles section. That's critical.
